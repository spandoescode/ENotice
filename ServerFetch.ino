...
const char* ssid     = "TrigyaTech";
const char* password = "nm3012vm1906";
...
void drawBitmap()
{
  ...
  Serial.println("Calling Fucntion");
  showBitmapFrom_HTTP("192.168.0.102", "/images/", "wall.bmp", w2 , h2 , false);
  delay(2000);
}
